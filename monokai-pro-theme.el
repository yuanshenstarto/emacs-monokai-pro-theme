...
;;;; ivy
     ...
     (ivy-current-match                            :foreground bg :background orange)
     (ivy-cursor                                   :foreground bg :background red)
     ...
     (ivy-minibuffer-match-face-4                  :foreground fg :background red)
     ...
     (ivy-prompt-match                             :foreground bg :background red)
     ...
     (swiper-background-match-face-1               :foreground bg :background red)
     (swiper-background-match-face-2               :foreground bg :background red)
     (swiper-background-match-face-3               :foreground bg :background red :weight bold)
     (swiper-background-match-face-4               :foreground fg :background red)
     (swiper-match-face-1                          :foreground bg :background red)
     (swiper-match-face-2                          :foreground bg :background red)
     (swiper-match-face-3                          :foreground bg :background red :weight bold)
     (swiper-match-face-4                          :foreground red :background red)
     (swiper-line-face                             :foreground fg-1 :background bg+1)
